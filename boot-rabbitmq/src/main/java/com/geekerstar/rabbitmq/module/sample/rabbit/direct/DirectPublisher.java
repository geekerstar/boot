package com.geekerstar.rabbitmq.module.sample.rabbit.direct;
...
public class DirectPublisher {
    ...
    //exchange 交换器名称
    @Value("${mq.config.exchange:log.direct}")
    private String exchange;

    //routingkey 路由键
    @Value("${mq.config.queue.info.routing.key:log.info.routing.key}")
