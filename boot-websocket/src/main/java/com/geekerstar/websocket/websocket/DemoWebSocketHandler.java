package com.geekerstar.websocket.websocket;

import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;
import com.geekerstar.websocket.handler.MessageHandler;
...
public class DemoWebSocketHandler extends TextWebSocketHandler implements InitializingBean {
    ...
    public void handleTextMessage(WebSocketSession session, TextMessage textMessage) throws Exception {
        ...
        try {
            // 获得消息类型
            JSONObject jsonMessage = JSONUtil.parseObj(textMessage.getPayload());
