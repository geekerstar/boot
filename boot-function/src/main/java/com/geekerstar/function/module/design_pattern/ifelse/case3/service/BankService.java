package com.geekerstar.function.module.design_pattern.ifelse.case3.service;
...
import com.geekerstar.function.module.design_pattern.ifelse.case3.entity.AbstractAPI;
import com.geekerstar.function.module.design_pattern.ifelse.case3.entity.CreateUserAPI;
import com.geekerstar.function.module.design_pattern.ifelse.case3.entity.PayAPI;
...
public class BankService {
    ...
    public static String createUser(String name, String identity, String mobile, int age) {
        ...
        return HttpRequest.post("http://localhost:45678/reflection/bank/createUser")
    ...
    public static String pay(long userId, BigDecimal amount) {
        ...
        //最后加上MD5作为签名
        stringBuilder.append(DigestUtils.md2Hex(stringBuilder.toString()));
        return HttpRequest.post("http://localhost:45678/reflection/bank/pay")
                .body(stringBuilder.toString())
                .execute()
                .body();
    }
    ...
    private static String remoteCall(AbstractAPI api) throws IOException {
        ...
        String result = HttpRequest.post("http://localhost:45678/reflection" + bankAPI.url())
                .body(param)
                .execute()
                .body();
